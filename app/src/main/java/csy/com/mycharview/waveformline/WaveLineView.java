...
//                moveMinX = smallSpaceX;
//                if (actionMoveDis>=0 && actionMoveDis<moveMinX){//每个点移动的最小距离是 屏幕宽度/点数
//                    actionMoveDis = moveMinX;
//                    Dbug.d("ACTION_MOVE","===actionMoveDis=1="+actionMoveDis);
//                }else if (actionMoveDis<0 && actionMoveDis >-moveMinX){
//                    actionMoveDis = - moveMinX;
//                    Dbug.d("ACTION_MOVE","===actionMoveDis=2="+actionMoveDis);
//                }else{
//                    Dbug.d("ACTION_MOVE","===actionMoveDis=3="+actionMoveDis);
//                }
                ...
                Dbug.d("==","====bord=1="+-(pointsList.size()*smallSpaceX*perPointXSpase - getWidth()));
                Dbug.d("==","====bord=2="+xRoundPoint+"====actionMoveDis=="+actionMoveDis);
                if (xRoundPoint>0 ){
                    xRoundPoint -= actionMoveDis;
...
//                if (xRoundPoint>0 || xRoundPoint < - pointsList.size()*smallSpaceX){
//                    Dbug.d(getClass().getSimpleName(),"==ACTION_MOVE==不能再移动啦==xRoundPoint=="+xRoundPoint);
//                    xRoundPoint -= actionMoveDis;
//                }else{
//                    invalidate();//重绘
//                }
